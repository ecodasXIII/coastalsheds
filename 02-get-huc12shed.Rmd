...
ncaa_siteID <- "NCCAGL10-GLBA10-031"
...
ncaa_siteIDs_toget_noGL <- grep("GL", ncaa_siteIDs_toget, value = TRUE, invert = TRUE)
```

```{r}
library(rslurm)
pars <- data.frame(ncaa_siteID = ncaa_siteIDs_toget_noGL, stringsAsFactors = FALSE)
